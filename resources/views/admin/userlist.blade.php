        ...
        $(document).ready(function(){
            ...
            $("#table-articles").bootgrid({
                formatters: {
                    ...
                    {
                    return '<button type="button" class="btn btn-xs btn-default command-edit" data-row-id="' + row.id + '" onclick="window.location = \'user/'+ row.id +'\'"><span class="glyphicon glyphicon-folder-open" ></span></button>';
                    }
                },
                converters: 
                {
